...
/*
    ...
    This is the final milestone for my final project in my Computer Architecture during my junior year at the
    University of Wisconsin - Milwaukee. For this milestone, we will finish the creation of a a Java program
    that will take MIPS machine code instructions and simulate the internal workings of a MIPS processor
    using a single-cycle datapath. This program will expand on that by having the ability to read assembly files
    and simulate running the assembly code. The output in the terminal will be exactly like the output in the terminal
    in the MARS MIPS simulator.
